...
### Url: https://www.superheroapi.com/api.php/access-key/

### Then attempt these parameteres:

### Url: https://www.superheroapi.com/api.php/access-key/:{id}
### Url: https://www.superheroapi.com/api.php/access-key/search/:{hero-name}
